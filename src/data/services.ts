...
export const services: Service[] = [
  ...
  },
  {
    ...
    full: 'Implementamos Sistemas de Gestión Empresarial (ERP) y Almacenes (SGA) robustos y totalmente integrados, unificando la logística, inventario, finanzas y recursos humanos en una sola plataforma. Obtén visibilidad total de tu cadena de suministro y toma decisiones basadas en datos en tiempo real, maximizando la eficiencia operativa y el control total de tu negocio.',    bgSize: '60% auto, cover',
    bgPosition: 'center 0px, center center'
  },
  {
